...
# 3. Populate Task Allocation Tables
for table in doc.tables:
...
# 4. Clear CD Disc Section Notes
CD_PHRASES = ["Ghi chú:", "đĩa CD", "Mỗi nhóm in 1 quyển", "Nhãn đĩa CD", "CNTT K23D", "Nội dung đĩa CD", "Hướng dẫn cái đặt", "Hướng dẫn cài đặt"]
for p in doc.paragraphs:
    if any(phrase.lower() in p.text.lower() for phrase in CD_PHRASES):
        p.text = ""

# 5. Populate ONLY Chapter 1 (Lock Chapters 2, 3 & Conclusion as untouched template placeholders)
