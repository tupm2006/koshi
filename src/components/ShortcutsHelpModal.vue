    ...
    <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-lg p-5 md:p-6 shadow-2xl border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 flex flex-col">
      ...
      <div class="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            <h2 class="text-sm md:text-base font-bold text-slate-900 dark:text-slate-100 font-mono">Keyboard Navigation Engine</h2>
            <p class="text-[11px] text-slate-500 dark:text-slate-400">Zero-latency Vim keybindings</p>
          </div>
        </div>
      ...
      <div class="py-4 space-y-2 text-xs divide-y divide-slate-100 dark:divide-slate-800/60 max-h-[60vh] overflow-y-auto">
        ...
        >
          <kbd class="px-2 py-1 rounded bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-[11px] font-bold">
            {{ s.key }}
          </kbd>
