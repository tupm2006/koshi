...
# Target URL: https://koshi.felixsu.qzz.io
# Author: Felix Anderson (felixsu)
# Maintainer & Core Team:
#   - Lead Architect & Developer: Felix Anderson / Phạm Minh Tú (felixsu)
...
1. Architect opens Koshi (`https://koshi.felixsu.qzz.io`) in a browser window.
